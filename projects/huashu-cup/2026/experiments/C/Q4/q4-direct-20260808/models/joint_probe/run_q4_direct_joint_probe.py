...
SEED, H0, HORIZON = 20260801, 2328, 72
H1 = H0 + HORIZON
QUEUE_SIZE, SHORTLIST_SIZE, LATENCY_GUARD_MS = 6, 5, 20.0
METHOD = "surrogate_assisted_fix_and_optimize_PROBE_ONLY"
SCENARIOS = {
    "observed": {"price": 1.0, "carbon": 1.0, "renewable": 1.0},
    "joint_stress": {"price": 1.2, "carbon": 1.2, "renewable": 0.7},
}
