...
SOURCE_MAIN_METHOD = "full_horizon_rolling_shadow_exchange::lagrangian_balanced"
SOURCE_BASELINE_METHOD = "full_horizon_FIFO_latency_feasible_local_first"

EXPECTED_INPUT_HASHES = {
    "q2_full_baseline_schedule.csv": "172d45d624d85f7cf7558606e551f7dee275ab726236c6b933b39d6282df370a",
    "q2_full_block_robustness.csv": "2ac7d8a6da49d09319359317931371b7f16c7f9e872a81f2d64a11e58dfdbaa4",
    "q2_full_candidate_schedule.csv": "d04a57ba3cd830c771bd97fe7a9f0efa62e97978139dbcfd094cc0f098ebad54",
    "q2_full_claim_proposals.json": "c46b83127d677bd0450f4b7f71d7a256907ea659c31a3d9e210c92feb972fc09",
    "q2_full_constraint_audit.json": "5828246813e019dfa0a49226a37eca61bc7ed6ee3a4c7d2eefe44ce5994b06aa",
    "q2_full_exchange_log.csv": "6bc223a7e692b799a871ee7433413d89516cf6d78d06d61a77e933d8bd2bcd56",
    "q2_full_hourly_profiles.csv": "129c23e73ed9d0ec7398f1a787d9426f0a8d54851a9153f3f96741871404dd47",
    "q2_full_risk_probes.csv": "a92c7ce125292aba537fe4b9ff37c234745f5d1e78f0189cd8329875fa3a7b47",
    "q2_full_run_manifest.json": "b6b6f96959c8c6af6561c9866c1ec3f5f29d3b0061ab375bdd4a11e3a62e570d",
    "q2_full_summary.json": "68f503df0646e34d9e76680b5c104c3720a5af443c662ba32427299ee02f8cb1",
    "run_q2_full_horizon.py": "6a39aa6eb6802a73057ae78528b18775ba2181924b7bb4fa8ad263f0214ce45f",
}
...
def source_records() -> list[dict[str, str]]:
    ...
    for name, expected_hash in EXPECTED_INPUT_HASHES.items():
        ...
        if actual_hash != expected_hash:
            raise ValueError(
                f"stale pinned Q2 input {path}: expected {expected_hash}, got {actual_hash}"
            )
        records.append(
            {
...
def main() -> None:
    ...
    if baseline_schedule["method"] != SOURCE_BASELINE_METHOD:
        raise ValueError("unexpected Q2 baseline source method label")
    if candidate_schedule["method"] != SOURCE_MAIN_METHOD:
