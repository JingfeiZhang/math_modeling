...
SOURCE_MAIN_METHOD_LABEL = "full_horizon_rolling_shadow_exchange::lagrangian_balanced"
...
POLICY = {
    "policy_id": "fixed_weight_balanced",
    "cost_weight": 1.0,
    "carbon_weight": 4.0,
    "wait_weight": 0.015,
...
def direct_input_hashes() -> list[dict[str, object]]:
    paths = ["workload_trace.xlsx", "GPU_information.xlsx", "network_latency.xlsx", "region_time_data.xlsx", "power_mapping.xlsx"]
    records = []
...
# BEGIN APPENDIX_Q2_ROLLING_EXCHANGE
# BEGIN APPENDIX_Q2_ROLLING_SETUP
...
# END APPENDIX_Q2_ROLLING_SETUP
# BEGIN APPENDIX_Q2_CANDIDATE_ENUMERATION
...
# END APPENDIX_Q2_CANDIDATE_ENUMERATION
# BEGIN APPENDIX_Q2_ACCEPTANCE
...
# END APPENDIX_Q2_ROLLING_EXCHANGE
...
def main(argv: list[str] | None = None) -> int:
    global STAGING, DATA_DIR, SEED
    parser = argparse.ArgumentParser(description="Q2 full-horizon rolling-exchange scheduler")
    ...
    manifest = {
        ...
        "question_id": "Q2",
        "engine": "python",
        "command": ["python", "code/q2/run_q2.py"],
        "environment": {
            "python": sys.version,
        ...
        "random_seed": SEED,
        "inputs": input_hashes,
        "code": {"runner": {"path": "code/q2/scheduler_core.py", "sha256": sha256(Path(__file__))}},
        "methods": {
            "main": MAIN_METHOD,
